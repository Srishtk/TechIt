...
class Organisation(models.Model):
    org_profile = models.ImageField(upload_to="Media/author")
    name = models.CharField(max_length=100, null=True)
    about_org = models.TextField()
...
class Course(models.Model):
    ...
    #     # You can generate a link based on your project's URL structure
    #     return f'http://127.0.0.1:8000/course/{self.slug}'
